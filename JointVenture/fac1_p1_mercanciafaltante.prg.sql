...
IF co_art!=co_artF
	messagebox(":.:ERROR CODIGO DE ARTICULO::",48,"Dpto Informatica :) :: Refrigeracion El Sol::")
ELSE
	IF co_ven!=co_venF
		messagebox(":.:ERROR CODIGO DE VENDEDOR::",48,"Dpto Informatica :) :: Refrigeracion El Sol::")
	ELSE		
		...
		If mensaje_sql(tresult_InsertMF,"Actualizado Satisfactoriamente","Error sql Insertando") <= 0
		   Return .F.
			...
			MESSAGEBOX("--> Registro de Mercancia Faltante <-- "+Chr(13)+Chr(13)+"Hola " + ven_des + Chr(13)+Chr(13)+ "Hemos registrado exitosamente la falta de " +STRTRAN(STR(canSolicitadaF),' ', '')+ " unidades de: "+Chr(13)+Chr(13)+ art_des +Chr(13)+"-->  Feliz Dia! <--",64,":.: Dpto Informatica :) Refrigeracion El Sol :.:")
		ENDIF
